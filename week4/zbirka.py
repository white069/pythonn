...
#Zadatak  22
# Задатак: Проја
# Кукурузни хлеб, проја, се прави мешањем кукурузног и пшеничног брашна и воде (наравно, по жељи можете
# додати јаја, со, сир, кајмак и слично, али ми ћемо разматрати само неопходне састојке). Неопходно је да
# употребљена количина кукурузног брашна буде двоструко већа од употребљене количине пшеничног брашна.
# Количина воде која се додаје у мешавину брашна је двоструко мања од укупне количине брашна. Одредити
# коју количину воде треба додати да бисмо умесили највећу могућу проју од кукурузног и пшеничног брашна
# којим располажемо.
# Улаз: У првој линији стандардног улаза налази се количина кукурузног, а у другој количина пшеничног
# брашна којом располажемо (реални бројеви).
# Излаз: Количину воде коју треба додати у мешавину брашна (реални број приказан на две децимале) 
#исписати у јединој линији стандардног излаза.
# Пример
# Улаз
# 1524
# 800
...
# psenicno=float(input('koliko psenicnog brasna imas: '))
# kukuruzno=float(input('koliko kukuruznog brasna imas: '))
# if (psenicno/kukuruzno)>2:
#     voda=(psenicno+kukuruzno)/2
# else:
#     pse=psenicno/2
#     kukuruzno=pse
#     voda=(psenicno+kukuruzno)/2
# print(format(voda,'.2f'))
#===================================================================
...
# У одељењу има n ученика, од чега k ученика уме да игра кошарку, а f уме да игра фудбал. На спортско
# такмичење повешће се сви ученици који умеју да играју оба спорта. Колико ће најмање, а колико највише
# ученика ићи на такмичење?
# Улаз: Са стандардног улаза учитавају се три цела броја:
# • n (20 ≤ n ≤ 30) - укупан број ученика у одељењу,
# • k (0 ≤ k ≤ n) - број ученика који играју кошарку,
# • f (0 ≤ f ≤ n) - број ученика који играју фудбал.
...
# n=int(input('ukupan broj ucenika u odeljenju '))
# k=int(input('ucenici koji igraju KOSARKUU '))
# f=int(input('ucenici koji igraju fucbal '))
# najmanje=n-((n-k)+(n-f))
# najvise=min(k,f)
# print(najmanje)
# print(najvise)
...
#===================================================================
#Zadatak  24            radi dobro ali za tacnije resenje treba pretvoriti ceo print u str(sto me mrzi)
# Задатак: Домине
# Зоран има две домине. На свакој домини су тачкицама представљене две цифре од 1 до 9. Напиши програм
# који одређује највећи број који Зоран може написати помоћу своје две домине (сваку од њих може окренути
# како жели и домине може поређати како жели).
# Улаз: Први ред стандардног улаза садржи бројеве на првој домини (раздвојене размаком), а други ред садржи
# бројеве на другој домини.
...
# d1,d2=map(int,input('domina 1 ').split())
# d3,d4=map(int,input('domina 2').split())

# maksimum1=max(d1,d2)
# maksimum2=max(d3,d4)
# if maksimum1>maksimum2:
#     print(max(d1,d2),min(d1,d2),max(d3,d4),min(d3,d4))
# elif maksimum1<maksimum2:
#     print(max(d3,d4),min(d3,d4),max(d1,d2),min(d1,d2))
# else:
...
#Zadatak  25
# Задатак: Интервали
# Дата су два затворена интервала реалне праве [a1, b1] и [a2, b2]. Написати програм којим се одређује: њихов
# покривач (најмањи интервал реалне праве који садржи дате интервале), пресек (највећи интервал реалне праве који је садржан у оба интервала ако постоји) и дужину њихове уније (дела реалне праве који ти интервали
# покривају).
# Улаз: Са стандардног улаза учитавају се четири реална броја: a1, b1, a2 и b2, при чему важи a1 < b1 и
# a2 < b2.
# Излаз: На стандардни излаз исписује се 5 реалних бројева (заокружених на две децимале): у првом реду
# исписују се леви и десни крај покривача раздвојени размаком, у наредном леви и десни крај пресека раздвојени размаком или текст presek ne postoji ако се интервали не секу и у трећем реду се исписује дужина
# уније.
# Пример 1
# Улаз
# 1
...
# a1=float(input('leva granica prvog intervala '))
# b1=float(input('desna granica prvog intervala '))
# a2=float(input('leva granica drugog intervala ' ))
# b2=float(input('desna granica drugog intervala '))

# print(min(a1,a2),max(b1,b2))                treba u dve decimale, tj format, ali me mrzi sad
# if max(a1,a2)<min(b1,b2):
#     print(max(a1,a2),min(b1,b2))
#     print(max(b1,b2)-min(a1,a2))
# else:
#     print('presek ne postoji')
#     print((b1-a1)+(b2-a2))
#===================================================================
...
# Улаз: Са стандардног улаза учитавају се два цела броја a и b (−105 ≤ a ≤ b ≤ 105
# ).
...
# Дат је правоугаоник чије су странице паралелне координатним осама. Одредити површину дела тог 
#правоугаоника који припада првом квадранту.
# Улаз: Са стандардног улаза учитавају се 4 цела броја који представљају координате темена једне дијагонале
# правоугаоника.
# Излаз: На стандардни излаз исписује се један цео број - површина дела правоугаоника у првом квадранту.
# Пример
# Улаз
# -3
# 5
